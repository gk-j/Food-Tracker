...
const inputStyles = StyleSheet.create({
  ...
  label: { fontFamily: "Inter_600SemiBold", fontSize: 15, color: Colors.dark.text },
  inputRow: {
    flexDirection: "row",
    alignItems: "center",
  ...
  input: { flex: 1, fontFamily: "Inter_700Bold", fontSize: 22, color: Colors.dark.text, padding: 0 },
  unit: { fontFamily: "Inter_400Regular", fontSize: 14, color: Colors.dark.textMuted },
});
...
export default function SettingsScreen() {
  ...
  const handleSave = () => {
    saveMutation.mutate({
      dailyCalorieGoal: parseFloat(calories) || 2000,
      dailyProteinGoal: parseFloat(protein) || 150,
      dailyCarbGoal: parseFloat(carbs) || 250,
      dailyFatGoal: parseFloat(fats) || 65,
    });
  };
      ...
      >
        ...
        <View style={styles.previewCard}>
          ...
          <View style={styles.macroBar}>
            <View style={[styles.macroBarSeg, { flex: pPct || 1, backgroundColor: Colors.dark.protein }]} />
            <View style={[styles.macroBarSeg, { flex: cPct || 1, backgroundColor: Colors.dark.carbs }]} />
            <View style={[styles.macroBarSeg, { flex: fPct || 1, backgroundColor: Colors.dark.fats }]} />
          </View>
...
const styles = StyleSheet.create({
  ...
  screenSub: { fontFamily: "Inter_400Regular", fontSize: 14, color: Colors.dark.textMuted, marginTop: -10 },
  section: { gap: 10 },
  sectionLabel: { fontFamily: "Inter_700Bold", fontSize: 18, color: Colors.dark.text },
  goalsList: { gap: 10 },
  previewCard: {
    backgroundColor: Colors.dark.card,
    borderRadius: 20,
  ...
  previewTitle: { fontFamily: "Inter_700Bold", fontSize: 16, color: Colors.dark.text },
  previewSub: { fontFamily: "Inter_400Regular", fontSize: 12, color: Colors.dark.textMuted, marginTop: -6 },
  macroBar: { flexDirection: "row", height: 12, borderRadius: 6, overflow: "hidden", gap: 2 },
  macroBarSeg: { borderRadius: 3 },
  macroBreakdownLabels: { flexDirection: "row", justifyContent: "space-around" },
  macroBreakdownLabel: { fontFamily: "Inter_600SemiBold", fontSize: 13 },
  aboutCard: {
    backgroundColor: Colors.dark.card,
    borderRadius: 16,
    borderWidth: 1,
  ...
  aboutTitle: { fontFamily: "Inter_700Bold", fontSize: 15, color: Colors.dark.text },
  aboutSub: {
